...
<body>
    ...
    <li id="selectProduct">
        ...
        <li id="purchase">
        <div class="accordion-header">
        <span class="k-icon k-plus"><span class="circle">2</span><span>Review and purchase</span></span>
        </div>
    <div class="accordion-content" style="display:none">
    <!--form id="payment_form" action="http://localhost:51400/api/CheckOut/" method="post" -->
    <form id="payment_form" action="http://devvmecom02.us.costar.local/api/CheckOut/" method="post" class="payment_form">
    ...
    <input type="hidden" id="CancelUrl" name="CancelUrl"  value="<%=Request.Url.GetComponents(UriComponents.SchemeAndServer, UriFormat.SafeUnescaped) + ResolveUrl("~/default.aspx") %>">    
        ...
        <div>
            <label class="fieldName">First Name:</label><input type="text" name="PaymentDetail.BillingAddress.FirstName" value="jane" size="25" /><br/>
            <label class="fieldName">Last Name:</label><input type="text" name="PaymentDetail.BillingAddress.LastName" value="doe" size="25" /><br/>
            <label class="fieldName">City:</label><input type="text" name="PaymentDetail.BillingAddress.City" value="Glendora" size="25" /><br/>
            <label class="fieldName">country:</label><input type="text" name="PaymentDetail.BillingAddress.Country" value="us" size="25" /><br/>
            <label class="fieldName">Address Line 1:</label><input type="text" name="PaymentDetail.BillingAddress.StreetLine1" value="2100 route 66" size="25" /><br/>
            <label class="fieldName">Address Line 2:</label><input type="text" name="PaymentDetail.BillingAddress.StreetLine2" size="25" /><br/>
            <label class="fieldName">State:</label><input type="text" name="PaymentDetail.BillingAddress.State" value="CA" size="25" /><br/>
            <label class="fieldName">Postal Code:</label><input type="text" name="PaymentDetail.BillingAddress.PostalCode" value="91789" size="25" /><br/>
            <label class="fieldName">Email:</label><input type="text" name="PaymentDetail.BillingAddress.EmailAddress" value="vip@loopnet.com" size="25" /><br/>         
        </div>
...
<script>
    var el = document.getElementById('ReferenceNumber');
    el.value = new Date().getMilliseconds();    
</script>
